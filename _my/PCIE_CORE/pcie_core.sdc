...
set_false_path -to {*|pcie_core:*map|altpcie_rs_serdes:rs_serdes|busy_altgxb_reconfig_r[0]}
#
...
#
set_multicycle_path -start -setup -from [get_keepers {*|pcie_core_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_ctl_wr}] $tl_cfg_ctl_wr_setup
set_multicycle_path -end -setup -from [get_keepers {*|pcie_core_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_ctl[*]}] [expr $tl_cfg_ctl_wr_setup + 2]
set_multicycle_path -end -hold -from [get_keepers {*|pcie_core_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_ctl[*]}] 3
#
set_multicycle_path -start -setup -from [get_keepers {*|pcie_core_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_sts_wr}] $tl_cfg_sts_wr_setup
set_multicycle_path -end -setup -from [get_keepers {*|pcie_core_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_sts[*]}] [expr $tl_cfg_sts_wr_setup + 2]
set_multicycle_path -end -hold -from [get_keepers {*|pcie_core_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_sts[*]}] 3
